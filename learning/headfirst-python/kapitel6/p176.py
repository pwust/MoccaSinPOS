...
def auswerten(dateiname):
    ...
    try:
        ...
        print(sportler_name + 's Bestzeiten sind: ' + str(sorted(set([säubern(t) for t in sportler]))[0:3]))
    except AttributeError as attrerr:
        pass
        #print('Attributfehler: ' + str(attrerr))

for datei in ('sarah2.txt', 'ron2.txt', 'mark2.txt', 'julie2.txt', 'MeinFehler.txt'):
    auswerten(datei)
